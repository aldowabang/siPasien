                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $prescription->medicine->name ?? 'Obat tidak ditemukan' }}
                                @if($prescription->medicine->code ?? false)
                                <br><small class="text-muted">Kode: {{ $prescription->medicine->code }}</small>
                                @endif
                            </td>
...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="alert alert-info">
            ...
            Tidak ada resep obat untuk rekam medis ini.
        </div>
    </div>
</div>
@endif
