...
--
-- Host: localhost:3306
-- Generation Time: Nov 12, 2025 at 02:23 PM
...
(4, '2025_11_09_052523_create_patients_table', 1),
(5, '2025_11_09_052611_create_visits_table', 1),
(6, '2025_11_09_052700_create_medical_records_table', 1),
(7, '2025_11_09_052725_create_medicines_table', 1),
(8, '2025_11_09_052758_create_prescriptions_table', 1),
(9, '2025_11_09_133643_update_users_table_add_role_phone_status', 1);
...
CREATE TABLE `users` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `role` enum('admin','dokter','perawat','registrasi') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'registrasi',
...
ALTER TABLE `medical_records`
  ADD PRIMARY KEY (`id`),
  ADD KEY `medical_records_visit_id_foreign` (`visit_id`);
...
ALTER TABLE `medicines`
  ...
  ADD KEY `medicines_code_name_index` (`code`,`name`);
...
ALTER TABLE `patients`
  ...
  ADD KEY `patients_nik_medical_record_number_index` (`nik`,`medical_record_number`);
...
ALTER TABLE `visits`
  ...
  ADD KEY `visits_visit_date_status_index` (`visit_date`,`status`),
  ADD KEY `visits_queue_number_index` (`queue_number`);
...
--
ALTER TABLE `medical_records`
  ADD CONSTRAINT `medical_records_visit_id_foreign` FOREIGN KEY (`visit_id`) REFERENCES `visits` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `prescriptions`
  ...
  ADD CONSTRAINT `prescriptions_medicine_id_foreign` FOREIGN KEY (`medicine_id`) REFERENCES `medicines` (`id`) ON DELETE CASCADE;
